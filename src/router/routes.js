...
const routes = [
  {
    ...
    children: [
      { path: '', component: () => import(/* webpackChunkname: "progresso" */ 'pages/items_campanhas.vue'), name: 'progresso' }
    ]
  },
  {
    path: '/campanhas',
    component: () => import('layouts/Default.vue'),
    children: [
      { path: '', component: () => import(/* webpackChunkname: "progresso" */ 'pages/Progresso.vue'), name: 'campanhas' },
  ...
  },
  {
    ...
    component: () => import('layouts/Default.vue'),
    children: [
      { path: '', component: () => import(/* webpackChunkname: "index" */ 'pages/Nova.vue'), name: 'interna' }
